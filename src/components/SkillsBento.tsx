...
export default function SkillsBento() {
  ...
  return (
    <section ref={containerRef} className="py-32 px-[5%] md:px-16 max-w-[1400px] mx-auto border-t border-os-border" id="skills">
      
      <div className="mb-16 border-b border-os-border pb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* Wide Card */}
        <div className="bento-card opacity-0 md:col-span-2 bg-[#0a0a0a] border border-os-border p-10 rounded-2xl flex flex-col gap-4 hover:bg-[#151515] transition-colors duration-500 group">
        ...
        {/* Standard Cards */}
        <div className="bento-card opacity-0 bg-[#0a0a0a] border border-os-border p-10 rounded-2xl flex flex-col gap-4 hover:bg-[#151515] transition-colors duration-500 group">
