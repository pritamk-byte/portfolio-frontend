  ...
  return (
    <section className="py-32 px-[5%] md:px-16 max-w-[1400px] mx-auto relative z-10" id="skills">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 auto-rows-[minmax(180px,auto)]">
        ...
        <div className="md:col-span-2 bg-[#050505] border border-zinc-800 rounded-2xl p-8 hover:border-zinc-700 transition-colors group relative overflow-hidden flex flex-col justify-between">
          ...
          <div className="flex gap-3 flex-wrap relative z-10">
            {['Java', 'Python', 'C'].map((skill) => (
              <span key={skill} className="px-5 py-2.5 bg-zinc-900/50 border border-zinc-800 rounded-lg text-zinc-200 text-sm font-medium hover:bg-zinc-800 hover:border-zinc-600 transition-colors cursor-default">
                {skill}
              </span>
            ))}
          </div>
        ...
        {/* 2. Database */}
        <div className="md:col-span-1 bg-[#050505] border border-zinc-800 rounded-2xl p-8 hover:border-zinc-700 transition-colors flex flex-col justify-between">
          ...
          <div className="flex gap-3 flex-wrap">
            <span className="px-5 py-2.5 bg-zinc-900/50 border border-zinc-800 rounded-lg text-zinc-200 text-sm font-medium hover:bg-zinc-800 hover:border-zinc-600 transition-colors cursor-default w-full text-center">
              SQL
            </span>
          </div>
        </div>
        ...
        <div className="md:col-span-1 bg-[#050505] border border-zinc-800 rounded-2xl p-8 hover:border-zinc-700 transition-colors flex flex-col justify-between">
          ...
          <div className="flex gap-2 flex-wrap">
            {['JavaScript', 'HTML5', 'CSS3'].map((skill) => (
              <span key={skill} className="px-4 py-2 bg-zinc-900/50 border border-zinc-800 rounded-lg text-zinc-300 text-sm hover:text-zinc-100 transition-colors cursor-default">
                {skill}
              </span>
            ))}
          </div>
        ...
        <div className="md:col-span-1 bg-[#050505] border border-zinc-800 rounded-2xl p-8 hover:border-zinc-700 transition-colors flex flex-col justify-between">
          ...
          <div className="flex gap-2 flex-wrap">
            {['Node.js', 'React.js'].map((skill) => (
              <span key={skill} className="px-5 py-2.5 bg-zinc-800/30 border border-zinc-700/50 text-zinc-200 rounded-lg text-sm font-medium hover:border-zinc-600 transition-colors cursor-default">
                {skill}
              </span>
            ))}
          </div>
        ...
        <div className="md:col-span-1 bg-[#020202] border border-zinc-800/50 rounded-2xl p-8 flex flex-col justify-between group cursor-default font-mono">
